...
public class AppRate {
    private final static String APP_TITLE = "Saayinsii Walii galaa Kutaa 8ffaa";// App Name
    private static final String APP_PNAME = "com.beckytech.saayinsiiwaliigalaakutaa8ffaa";// Package Name
